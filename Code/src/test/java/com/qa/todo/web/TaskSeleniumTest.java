...
public class TaskSeleniumTest {
	...
	public void testCreateTask() {
		...
		WebElement taskNameTextField = driver.findElement(By.id("taskName"));
		WebElement taskDescTextField = driver.findElement(By.id("taskDesc"));
		WebElement createBtn = driver.findElement(By.xpath("/html/body/div[1]/form/button"));
		taskNameTextField.sendKeys("Complete Project");
		...
		WebElement taskDesc = driver.findElement(By.xpath("/html/body/div[1]/table/tbody/tr[2]/td[2]"));
